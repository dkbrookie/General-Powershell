...
If($answer -eq "y") {
  ...
  $vd1 = New-VirtualDisk -StoragePoolFriendlyName “Optane Boosted Storage” -FriendlyName TieredSpace -StorageTiers @($ssd_tier, $hdd_tier) -StorageTierSizes @(52GB, 9310GB) -ResiliencySettingName Simple -WriteCacheSize 1GB
} Else {
